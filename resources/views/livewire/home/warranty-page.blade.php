<div>
    ...
    <section class="bg-white flex relative items-center justify-center min-h-[50vh] px-4">
        ...
        <div class="max-w-4xl text-center">
            <h1 class="text-blue-700 font-bold text-3xl md:text-4xl mb-4">
                Extended Warranty Program
            </h1>
            <p class="text-gray-700 text-base md:text-lg mb-4">
                SecurTek offers Extended Warranty Programs which cover repair or replacement for any hardware or sensors
                installed by a SecurTek Dealer, connected to your security system.
            </p>
            <p class="text-gray-700 text-base md:text-lg mb-8">
                For full details and options, speak to an Authorized SecurTek Dealer.
            </p>
            <p class="text-gray-400 text-xs md:text-sm max-w-3xl mx-auto leading-tight">
                SecurTek’s Extended Warranty Program does not cover: Any defect or failure of the equipment due to
                customers’ negligence, misuse or abuse, Acts of God or third parties, changes or upgrades, wear and
                tear, or battery replacement. Is currently only available on your basic security equipment which
                excludes: video cameras, video storage devices, door locks, thermostats, garage door openers and any
