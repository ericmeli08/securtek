<div class="flex flex-col gap-0">
    ...
    <section class="hero-section relative w-screen overflow-hidden min-h-[70vh] lg:min-h-screen flex items-center">
        ...
        <!-- Help Banner -->
        <div class="absolute bottom-0 left-0 right-0 min-h-[20vh] py-4  bg-primary-700 text-black  z-20">
            <div class="relative flex justify-center items-center w-full h-full" >
                <div style="clip-path: polygon(0 0%, 80% 0%, 100% 100%, 0 100%);"
                class="absolute bottom-0 left-0 w-[40%] min-h-[100%] bg-primary-800/40  ">
            </div>
                <div class="max-w-4xl z-10 mx-auto text-white  px-4 sm:px-6 text-center lg:px-8 flex flex-col sm:flex-row items-center justify-between">
                    When it comes to growing your business, SecurTek's Authorized Dealer Program will help you win in almost any market in Canada. Our program is strong enough to be flexible! We provide the tools and support to help independent security companies like yours, grow and prosper in the industry.
                </div>
            </div>
        </div>
    </section>
...
<div>
  <main class="max-w-3xl mx-auto px-6 py-12">
    <h1 class="text-center text-3xl sm:text-4xl font-extrabold text-blue-600 mb-4">
      Launch Your Business
    </h1>
    <p class="text-center text-orange-500 font-semibold max-w-xl mx-auto mb-8 text-sm sm:text-base">
      You acquired a security company or expanded into the alarm industry
    </p>
    <ul class="space-y-0 max-w-xl mx-auto text-gray-700 text-sm sm:text-base">
      <li class="flex items-start gap-2 text-sm justify-start">
        <span class="text-orange-500 font-bold ">›</span>
        <span>Your business is a growing concern and you need cash flow to fund your growth</span>
      </li>
      <li class="flex items-start gap-2 text-sm justify-start">
        <span class="text-orange-500 font-bold ">›</span>
        <span>You need marketing assistance to open new markets</span>
      </li>
      <li class="flex items-start gap-2 text-sm justify-start">
        <span class="text-orange-500 font-bold ">›</span>
        <span>You need support when loading and servicing alarm customers</span>
      </li>
      <li class="flex items-start gap-2 text-sm justify-start">
        <span class="text-orange-500 font-bold ">›</span>
        <span>You need access to quality security products, reliable suppliers, and dealer pricing</span>
      </li>
      <li class="flex items-start gap-2 text-sm justify-start">
        <span class="text-orange-500 font-bold ">›</span>
        <span>You need partners across Canada to extend your service reach</span>
      </li>
    </ul>
    <div class="mt-10 text-center">
      <button
        type="button"
        class="bg-blue-600 text-white font-semibold px-6 py-2 rounded-md hover:bg-blue-700 transition-colors duration-200"
      >
        LEARN MORE
      </button>
    </div>
  ...
  <main class="max-w-3xl mx-auto px-6 py-12">
    ...
    <ul class="space-y-0 max-w-xl mx-auto text-gray-700 text-sm sm:text-base">
      <li class="flex items-start gap-2 text-sm justify-start">
        <span class="text-orange-500 font-bold ">›</span>
        <span>You need stable and predictable funding</span>
      </li>
      <li class="flex items-start gap-2 text-sm justify-start">
        <span class="text-orange-500 font-bold ">›</span>
        <span>You need to invest in inventory, staff, and marketing</span>
      </li>
      <li class="flex items-start gap-2 text-sm justify-start">
        <span class="text-orange-500 font-bold ">›</span>
        <span>You need a partner who is willing to reinvest in your existing customers to maximize customer retention and grow RMR</span>
      </li>
      <li class="flex items-start gap-2 text-sm justify-start">
        <span class="text-orange-500 font-bold ">›</span>
        <span>You want access to new lines of business</span>
      </li>
      <li class="flex items-start gap-2 text-sm justify-start">
        <span class="text-orange-500 font-bold ">›</span>
        <span>You want to open-up new markets</span>
      </li>
    </ul>
    <div class="mt-10 text-center">
      <button
  ...
  <main class="max-w-3xl mx-auto px-6 py-12">
    ...
    <ul class="space-y-0 max-w-xl mx-auto text-gray-700 text-sm sm:text-base">
      <li class="flex items-start gap-2 text-sm justify-start">
        <span class="text-orange-500 font-bold ">›</span>
        <span>You need to turn equity into cash for life's special moments</span>
      </li>
      <li class="flex items-start gap-2 text-sm justify-start">
        <span class="text-orange-500 font-bold ">›</span>
        <span>You need to remove administrative headaches (billing, collections, etc.)</span>
      </li>
      <li class="flex items-start gap-2 text-sm justify-start">
        <span class="text-orange-500 font-bold ">›</span>
        <span>You want to maintain a relationship with your customers</span>
      </li>
      <li class="flex items-start gap-2 text-sm justify-start">
        <span class="text-orange-500 font-bold ">›</span>
        <span>You need stable and predictable cash flow but retain ownership of your business</span>
      </li>
    </ul>
    <div class="mt-10 text-center">
      <button
  ...
  <main class="max-w-3xl mx-auto px-6 py-12">
    ...
    <ul class="space-y-0 max-w-xl mx-auto text-gray-700 text-sm sm:text-base">
      <li class="flex items-start gap-2 text-sm justify-start">
        <span class="text-orange-500 font-bold ">›</span>
        <span>You need to maximize your payout</span>
      </li>
      <li class="flex items-start gap-2 text-sm justify-start">
        <span class="text-orange-500 font-bold ">›</span>
        <span>You have a timeline and you need an experienced buyer who will navigate a smooth transition to the finish line</span>
      </li>
      <li class="flex items-start gap-2 text-sm justify-start">
        <span class="text-orange-500 font-bold ">›</span>
        <span>Your customers need world class monitoring with continuing service and support</span>
      </li>
      <li class="flex items-start gap-2 text-sm justify-start">
        <span class="text-orange-500 font-bold ">›</span>
        <span>You need to know that your customers are in good hands and feel that their business is appreciated</span>
      </li>
    </ul>
    <div class="mt-10 text-center">
      <button
