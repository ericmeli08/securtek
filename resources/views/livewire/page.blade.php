<div class="flex flex-col gap-0">
    ...
    <section class="overflow-hidden min-h-[80vh]  bg-white">
    ...
    <section class=" min-h-[80vh] overflow-hidden block bg-gray-50">
        <div class="max-w-full  ">
            <div class="grid grid-cols-1  lg:grid-cols-2 gap-0 items-center">
    ...
    <!-- Safety Section -->
    <section class=" min-h-[80vh] overflow-hidden bg-white">
        <div class="max-w-full ">
    ...
    <section class="min-h-[80vh] bg-white ">
        <div class="w-full  h-full mx-auto ">
            <div class=" relative text-center h-full w-full  flex flex-col justify-center items-center">
                <div
                    class="absolute transform z-0 bg-[radial-gradient(circle,_#1e3a8b40_0%,_#fff_100%)] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[100%] min-h-[100%] ">
                </div>
